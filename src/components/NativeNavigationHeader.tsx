...
interface NativeNavigationHeaderProps {
  ...
  /** Hide the large title entirely — useful for screens that have their own hero header */
  compactOnly?: boolean;
}
...
export function NativeNavigationHeader({
  ...
  const [isCollapsed, setIsCollapsed] = useState(compactOnly);
