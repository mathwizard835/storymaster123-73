...
const Index = () => {
  ...
  useEffect(() => {
    try {
      ...
      if (token) {
        ...
        try {
          localStorage.removeItem("demo_story_used");
        } catch (_) {
          /* ignore */
        }
        setDemoUsed(false);
  ...
  return (
    <>
        ...
        <div className="relative z-10 flex min-h-screen items-center justify-center px-6">
          <div className="max-w-4xl text-center animate-enter">
            <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold tracking-tight drop-shadow-2xl mb-4 sm:mb-6">
              ...
              <span className="block text-xl sm:text-2xl md:text-3xl lg:text-5xl mt-2 text-white">
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-blue-50 via-blue-50/60 to-blue-100 border-y border-blue-100">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-background/60 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-blue-100">
            <BookOpen className="h-5 w-5 text-primary" />
            <span className="text-sm font-semibold text-foreground">Real Reading, Real Results</span>
          </div>
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4">
            <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">8+ Hours</span>{" "}
            of Reading Monthly
          </h2>
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            That adds up to <strong className="text-foreground">nearly 100 hours of reading a year</strong> — all from
            screen time kids actually want.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="bg-background/60 backdrop-blur-sm rounded-xl p-5 border border-blue-100">
              <div className="text-3xl font-extrabold text-blue-600 mb-1">2,500+</div>
              <p className="text-sm text-muted-foreground">Words per epic story</p>
            </div>
            <div className="bg-background/60 backdrop-blur-sm rounded-xl p-5 border border-blue-100">
              <div className="text-3xl font-extrabold text-blue-600 mb-1">12</div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <h2 className="text-4xl md:text-5xl font-bold mb-6">Why Kids Love StoryMaster Kids</h2>
              <p className="text-xl text-muted-foreground mb-8">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="bg-background p-6 rounded-xl shadow-sm border border-border text-center">
              <div className="text-3xl font-extrabold text-primary mb-2">8+</div>
              <p className="text-sm font-medium">Hours of Reading Monthly</p>
              <p className="text-xs text-muted-foreground mt-1">nearly 100 hours of reading a year</p>
            </div>
            <div className="bg-background p-6 rounded-xl shadow-sm border border-border text-center">
      ...
      <section className="py-20 px-6 bg-background">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-primary/10 border border-primary/30 rounded-2xl p-8 mb-8 text-center">
            <p className="text-2xl font-bold text-primary mb-2">Try a Free Story</p>
